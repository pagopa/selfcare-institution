...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Problem> handleResourceNotFoundException(HttpServletRequest request, ResourceNotFoundException ex) {
        log.error("ResourceNotFoundException Occurred --> URL:{}, MESSAGE:{}, STATUS: {}",request.getRequestURL(), ex.getMessage(), HttpStatus.NOT_FOUND, ex);
    ...
    public ResponseEntity<Problem> handleResourceConflictException(HttpServletRequest request, ResourceConflictException ex) {
        log.error("ResourceConflictException Occurred --> URL:{}, MESSAGE:{}, STATUS: {}",request.getRequestURL(), ex.getMessage(), HttpStatus.CONFLICT, ex);
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
    ...
    public ResponseEntity<Problem> handleInvalidRequestException(HttpServletRequest request, InvalidRequestException ex) {
        log.error("InvalidRequestException Occurred --> URL:{}, MESSAGE:{}, STATUS:{}",request.getRequestURL(), ex.getMessage(), HttpStatus.BAD_REQUEST, ex);
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
    ...
    public ResponseEntity<Problem> handleValidationException(HttpServletRequest request, ValidationException ex) {
        log.error("ValidationException Occurred --> URL:{}, MESSAGE:{}, STATUS:{}",request.getRequestURL(), ex.getMessage(), HttpStatus.BAD_REQUEST, ex);
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
    ...
    public ResponseEntity<Problem> handleMsCoreException(HttpServletRequest request, MsCoreException ex) {
        log.error("Exception Occurred --> URL:{}, MESSAGE:{}, STATUS:{}",request.getRequestURL(), ex.getMessage(), INTERNAL_SERVER_ERROR, ex);
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
    ...
    public ResponseEntity<Problem> handleException(HttpServletRequest request, Exception ex) {
        log.error("{} Occurred --> URL:{}, MESSAGE:{}, STATUS:{}",ex.getCause(), request.getRequestURL(), ex.getMessage(), HttpStatus.BAD_REQUEST, ex);
